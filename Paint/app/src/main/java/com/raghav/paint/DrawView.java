...
public class DrawView extends View {
    ...
    private float mX, mY;
    private Path mPath;
    //lớp Paint bao gồm thông tin về màu sắc và kiểu dáng
    //cách vẽ các hình học, văn bản và bitmap
    private Paint mPaint;
    //ArrayList để lưu trữ tất cả các nét vẽ do người dùng vẽ trên Canvas
    ...
    //Bộ tạo để khởi tạo tất cả các thuộc tính
    ...
    public DrawView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mPaint = new Paint();
        //các phương pháp dưới đây làm mịn các bản vẽ của người dùng
